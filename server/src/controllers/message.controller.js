...
export const getUsersForSidebar = async (req, res) => {
  try {
    ...
    // Get all users except the logged-in user, exclude passwords
 ...
 * Send a message (text and/or image) to the specified user
 */
export const sendMessage = async (req, res) => {
  try {
    ...
    let imageUrl;
    // If an image is attached, upload it to Cloudinary
    if (image) {
